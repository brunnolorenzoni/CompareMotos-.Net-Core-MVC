...
namespace CompareMotos.Controllers
{
    public class FuelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FuelId,Capacity,Type,Feeding")] Fuel fuel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuelId,Capacity,Type,Feeding")] Fuel fuel)
        {
            if (id != fuel.FuelId)
            {
                return NotFound();
