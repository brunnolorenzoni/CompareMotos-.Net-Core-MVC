...
namespace CompareMotos.Controllers
{
    public class TimeCyclesController : Controller
    {
        ...
        public TimeCyclesController(CompareMotosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TimeCycleId,Name")] TimeCycle timeCycle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TimeCycleId,Name")] TimeCycle timeCycle)
        {
